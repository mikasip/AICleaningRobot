# -*- coding: utf-8 -*-
"""
Created on Sun Mar 21 00:21:55 2021
...
class DuelingDeepQNetwork(keras.Model):
    def __init__(self, n_actions, fc1_dims, fc2_dims):
        ...
        self.cnn1 = keras.layers.Conv2D(64,4, data_format='channels_last')
        #self.cnn2 = keras.layers.Conv2D(32, 4, data_format='channels_last')
        self.fla = keras.layers.Flatten()
...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size,
                 ...
                 fc2_dims=256, replace=100, q_eval_model_file="eval_file", q_target_model_file="target_file"):
    ...
    def save_models(self):
        self.q_eval.save(self.q_eval_model_file, save_format="tf")
        self.q_next.save(self.q_target_model_file, save_format="tf")
        print('... saving models ...')
